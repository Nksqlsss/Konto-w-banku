...
public class KontoPlusTests
{
    ...
    [TestMethod]
    public void Konstruktor_PoprawnyKlient_TworzyKontoPlus()
    {
        var konto = new Bank.KontoPlus("Jan", 100, 50);
    ...
    {
        Assert.ThrowsException<ArgumentException>(() => new Bank.KontoPlus("Jan", 100, -50));
    }
    ...
    {
        var konto = new Bank.KontoPlus("Jan", 100, 50);
        konto.Wyplata(120); // przekracza bilans ale mieści się w limicie
